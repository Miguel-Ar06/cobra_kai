...
<body>
    <img style="z-index: -1; right: 0; padding-top: 10%; padding-right: 70%;" src="media/letrasrojas.png" class="float-end position-absolute" alt="" class="float-end">
    <img style="z-index: -1; right: 0; padding-top: 80%; padding-right: -30%;" src="media/letrasrojas.png" class="float-end position-absolute" alt="" class="float-end">
    <?php require 'templates/navbar.html.php' ;?>
    <div id="espacio_vacio" style="padding-top: 200px; position: relative; z-index: 1;"></div>


    <p class="text-center text-warning dead-stock titulo mb-5" style="font-size: 8rem;">Inicia Sesion</p>
            ...
            <div class="col-6"> 
                ...
                <div class="row mb-5"> 
                    <div class="col text-center">
                        <a href="perfil.php"><button class="boton-amarillo text-center" style="padding-right: 15%; padding-left: 15%">Ingresar</button></a>
                    </div>
                </div>

                <div class="row mb-5"> 
                    <div class="col">
                        <p class="h3 text-white dead-stock text-center" >Si no tienes una cuenta inicia sesion</p>
                    </div>
                </div>

                <div class="row mb-5"> 
                    <div class="col text-center">
                        <a href="registro.php"><button class="boton-amarillo text-center">Registrate</button></a>
                    </div>
                </div>
            </div> 
        </div>
